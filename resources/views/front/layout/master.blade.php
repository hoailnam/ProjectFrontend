...
<head>
    ...
    <title>@yield('title')| Watchshop</title>
            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.php"><img src="front/assets/img/logo/logo.png" alt=""></a>
                        </div>
                        <!-- Main-menu -->
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <li class="{{ (request()->segment(1)=='')? 'about':''}}"><a href="./about">about</a></li>
                            ...
                            <ul>
                                ...
                                <div class="dropdown ">
                                    <button type="button" class="dropdown-toggle" data-toggle="dropdown">
                                        <li> <a href="#"><span class="flaticon-user"> {{auth()->user()->name}} </span></a></li>
                                    </button>
                                ...
                                @endauth
                                @else
                                <li> <a href="{{route('dang-nhap')}}"><span class="flaticon-user"> </span></a></li>
                                @endif
                                <li><a href="{{url('/Cart/showCart/')}}"><span class="flaticon-shopping-cart"> {{Cart::count()}}</span></a> </li>
                            </ul>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
    ...
    <div class="search-model-box">
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <form action="shop" class="search-model-form">
                <input name="search" type="text" placeholder="Searching key.....">
